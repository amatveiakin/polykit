...
void pybind_delta(py::module_& m) {
  ...
  m.def("substitute_variables_0_based", py::overload_cast<const DeltaExpr&, const XArgs&>(&substitute_variables_0_based), "Substitutes variable into a DeltaExpr; can substitute Inf");
  m.def("substitute_variables_1_based", py::overload_cast<const DeltaExpr&, const XArgs&>(&substitute_variables_1_based), "Substitutes variable into a DeltaExpr; can substitute Inf");
