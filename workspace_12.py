...
from tensor import Inf, Tensor, d_monom_to_str, d_monoms_with_n_distinct_chars
...
# format.print_expression("LHR", to_lyndon_basis(lhs), element_to_str=d_monom_to_str)
