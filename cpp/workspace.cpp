...
int main(int /*argc*/, char *argv[]) {
  ...
  // for (const int num_points : range_incl(4, 13)) {
  //   const auto points = to_vector(range_incl(1, num_points));
  //   std::cout << "p=" << num_points << ": ";
  //   std::cout << compute_polylog_space_dim(CB1(points), DISAMBIGUATE(identity_function)) << "\n";
  // }


  // for (const int num_points : range_incl(4, 11)) {
  //   const auto points = to_vector(range_incl(1, num_points));
  //   PolylogSpace l1 = L1(points);
  //   Profiler profiler;
  //   const PolylogNCoSpace space_a = mapped(
  //     cartesian_combinations<DeltaExpr>({{l1, 2}}),
  //     DISAMBIGUATE(ncoproduct_vec)
  //   );
  //   profiler.finish("space_a");
  //   for (const auto& space : {space_a}) {
  //     check_space_weight_eq(space, 2);
  //     std::cout << "---\n";
  //     std::cout << "p=" << num_points << "\n";
  //     const auto description1 = polylog_space_kernel_describe(space, DISAMBIGUATE(identity_function), [](const auto& expr) {
  //       return std::make_tuple(keep_non_weakly_separated(expr));
  ...
  // const auto points = to_vector(range_incl(1, num_points));
  // PolylogSpace fx;
  // for (const auto& p : combinations(points, 2)) {
  ...
  // Profiler profiler;
  // const PolylogNCoSpace space_a = mapped(
  //   cartesian_combinations<DeltaExpr>({{l2, 1}, {l1, 1}}),
  //   DISAMBIGUATE(ncoproduct_vec)
  // );
  // profiler.finish("space_a");
  // const PolylogNCoSpace space_b = mapped(
  //   cartesian_combinations<DeltaExpr>({{l1, 3}}),
  //   DISAMBIGUATE(ncoproduct_vec)
  // );
  // profiler.finish("space_b");
  // for (const auto& space : {space_a, space_b}) {
  //   check_space_weight_eq(space, 3);
  //   std::cout << "---\n";
  //   const auto description1 = polylog_space_kernel_describe(space, DISAMBIGUATE(identity_function), [](const auto& expr) {
  //     return std::make_tuple(keep_non_weakly_separated(expr));
  //   });
  ...
  // const PolylogNCoSpace space_a = mapped(
  //   concat(
  //     cartesian_combinations<DeltaExpr>({{l3, 1}, {l1, 1}}),
  //     cartesian_combinations<DeltaExpr>({{l2, 2}})
  //   ),
  //   DISAMBIGUATE(ncoproduct_vec)
  // );
  // profiler.finish("space_a");
  // const PolylogNCoSpace space_b = mapped(
  //   cartesian_combinations<DeltaExpr>({{l2, 1}, {l1, 2}}),
  //   DISAMBIGUATE(ncoproduct_vec)
  // );
  // profiler.finish("space_b");
  // const PolylogNCoSpace space_c = mapped(
  //   cartesian_combinations<DeltaExpr>({{l1, 4}}),
  //   DISAMBIGUATE(ncoproduct_vec)
  // );
  // profiler.finish("space_c");
  // for (const auto& space : {space_a, space_b, space_c}) {
  //   check_space_weight_eq(space, 4);
  //   std::cout << "---\n";
  //   const auto description1 = polylog_space_kernel_describe(space, DISAMBIGUATE(identity_function), [](const auto& expr) {
  //     return std::make_tuple(keep_non_weakly_separated(expr));
  //   });
